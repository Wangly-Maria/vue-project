...
<template>
	<div class="header-bar">
		...
		<ul class="nav">
			<li>
				<router-link style="color:#2384E8">电影</router-link>
			</li>
			<li>
				<router-link style="color:#2384E8">图书</router-link>
			</li>
			<li>
				<router-link style="color:#2384E8">广播</router-link>
			</li>
			<li>
				<router-link style="color:#2384E8">小组</router-link>
			</li>
		</ul>
		<span class="talion" @click="showTailion"></span>
	</div>
</template>
<script>
export default {
